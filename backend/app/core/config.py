...
class Settings(BaseSettings):
    ...
    # Alternativas en variables de entorno (útil en Railway sin Mount Files).
    # Prioridad: B64 > PEM > PATH. El modo B64 es el más confiable porque no se
    # rompe con saltos de línea en los UI de variables de entorno.
    AFIP_CERT_PEM: str = ""
    AFIP_KEY_PEM: str = ""
    AFIP_CERT_B64: str = ""
    AFIP_KEY_B64: str = ""
