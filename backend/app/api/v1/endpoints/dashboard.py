...
def get_dashboard(
    ...
    return service.get_dashboard_completo()
...
def get_kpis(
    ...
    service = DashboardService(db)
    return service.get_kpis_principales()
...
def get_pedidos_recientes(
    ...
    service = DashboardService(db)
    return service.get_pedidos_recientes(limit=limit)
...
def get_lotes_en_proceso(
    ...
    service = DashboardService(db)
    return service.get_lotes_en_proceso(limit=limit)
...
def get_movimientos_hoy(
    ...
    service = DashboardService(db)
    return service.get_resumen_movimientos_hoy()
