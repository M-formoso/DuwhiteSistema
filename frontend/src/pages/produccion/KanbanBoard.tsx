    ...
    <div className="h-[calc(100vh-120px)] flex flex-col">
      ...
      {isLoading ? (
        ...
        <div className="flex gap-4 overflow-x-auto flex-1 pb-2">
          {/* Columna "En Camino" - Pedidos levantados sin lote */}
          <div className="flex-shrink-0 w-80 flex flex-col">
            <Card className="flex flex-col h-full">
              ...
              <CardContent className="p-2 space-y-2 flex-1 overflow-y-auto">
                {!pedidosEnCamino || pedidosEnCamino.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-gray-400">
                    <Truck className="h-8 w-8 mb-2" />
                    <span className="text-sm">Sin pedidos en camino</span>
                  </div>
                ) : (
                    ...
                    >
                      <CardContent className="p-3">
                        ...
                        <div className="mt-3 pt-2 border-t border-amber-200">
                          <Button
                            size="sm"
                            className="w-full text-xs bg-amber-500 hover:bg-amber-600"
                            onClick={(e) => {
                              e.stopPropagation();
                              navigate(`/produccion/lotes/nuevo?pedido_id=${pedido.id}`);
                            }}
                          >
